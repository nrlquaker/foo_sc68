...
`make package` produces the `.fb2k-component` in the layout foobar2000
expects for installing a component: a `mac/foo_sc68.component/` folder at
the zip's root (plus a `README.txt` with install instructions for whoever
downloads it).

## Notes

- **arm64 only** (no x86_64/Intel support currently).
